...
function NewMedical() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "تسجيل حالة طبية" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, className: "grid gap-5 md:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "sphone", children: "هاتف الطالب" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "sphone" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pphone", children: "هاتف ولي الأمر" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "pphone" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "illness", children: "نوع المرض" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "illness" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "notes", children: "ملاحظات" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { id: "notes", rows: 3 })
      ] }),
