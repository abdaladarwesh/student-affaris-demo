...
function NewViolation() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { title: "تسجيل مخالفة جديدة" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, className: "grid gap-5 md:grid-cols-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "date", children: "التاريخ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "date", type: "date", defaultValue: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "class", children: "اسم الفصل" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "class" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ref", children: "جهة التحويل" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "ref" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "proc", children: "الإجراء المتبع" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "proc" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "v", children: "المخالفة" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { id: "v", rows: 3 })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "sig", children: "التوقيع (اسم المسجل)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "sig" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 md:col-span-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 flex justify-end gap-3 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: () => navigate({
          to: "/violations"
        }), children: "إلغاء" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", children: "حفظ المخالفة" })
      ] })
    ] }) }) })
  ] });
}
export {
  NewViolation as component
};
